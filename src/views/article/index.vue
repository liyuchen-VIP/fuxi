    ...
    <el-card class="screen">
      ...
      <el-form :model="screenForm" label-width="80px">
        ...
        <el-form-item label="频道：">
          <el-select v-model="screenForm.channel_id" size="small">
            <!--
                  指定 key 作为唯一标识
                  label 看到的文字
                  value 文字的值
    ...
    <el-card>
      ...
      <el-table :data="tableData">
        ...
        <el-table-column prop label="操作">
          <template slot-scope="scope">
            <el-row>
              <el-button type="primary" plain icon="el-icon-edit" @click="goPub(scope.row.id)" circle></el-button>
              <el-button type="danger" plain icon="el-icon-delete" @click="del(scope.row.id)" circle></el-button>
            </el-row>
          </template>
        </el-table-column>
      </el-table>
